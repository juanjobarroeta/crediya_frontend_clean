...
const sectionList = [
  {
    ...
    links: [
      ...
      { href: "/create-loan", label: "Crear Préstamo (Legacy)", icon: "➕" },
  ...
  },
  {
    ...
    links: [
      ...
      { href: "/customer/1", label: "Perfil Cliente", icon: "👥" },
    ],
  },
  {
    key: "administracion",
    ...
    links: [
      ...
      { href: "/admin/loans", label: "Aprobaciones", icon: "✅" },
  ...
  },
  {
    ...
    links: [
      { href: "/investigation", label: "Formulario de Crédito", icon: "📝" },
      { href: "/admin/investigations", label: "Ver Investigaciones", icon: "🔍" },
      { href: "/investigation-stepper", label: "Investigación (Móvil)", icon: "📱" },
    ],
  },
];
